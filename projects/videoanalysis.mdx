...
<MySlideshow
  imgs={["va-mg-image.png", "va-mg.jpg", "va-mg2.jpg", "va-mg-theory.jpg"]}
  captions={[
    ...
    "To create motiongrams, you reduce motion video frames into one-dimensional matrices and print them across a canvas.",
  ]}
/>
