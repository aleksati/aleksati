...
, like a musical ensemble reaching a state of rhythmical unity.

We find syncronization .. most famous is probably fireflies,

observed in the light pulses of large groups of fireflies

The Kuramoto model is a simple and well-known mathematical framework for understanding synchronization in globally coupled non-linear oscillators, developed by Yoshiki Kuramoto in the 1970s. In simple terms, the model describes how groups of weakly interacting oscillators synchronize with each other, just like what happens with Ligeti's metronomes.

With the Kuramoto model, we can extract the phase of each oscillator in a system given the following equation:
