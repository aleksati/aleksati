...
In the code, I define a global class where each instance of that class represents an individual coffee owner/company. Every class instance (usually referred to as an object) possesses a range of properties defined by the coffee owners' data points in the dataset. In my example, I use class properties that define the shape, color, sound, position, and body length of my object instances.
