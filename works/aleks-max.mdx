...
type: "work"
summary: "aleks.max is my tiny library of Max abstractions for audio, video and data processing. It's an effort to clean up and publish some of my Max code that I believe can be useful to others."
---
