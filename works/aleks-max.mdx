...
type: "work"
summary: "aleks.max is my small library of Max abstractions for audio, video and data processing. It's a continous effort to publish some of my Max code that I believe can be useful to others."
---
