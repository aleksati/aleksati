---
title: "A Digital Poème Symphonique"
date: "2023-12-9"
keywords:
  [
    "audio",
...
type: "work"
summary: "To celebrate the 100th birthday of modernist composer György Ligeti, I built some software to perform one of his most renowned pieces, Poème Symphonique for 100 metronomes, using MaxMSP and machine learning tools for realtime audio processing. Full performance on YouTube!"
---
...
Sometime in the fall of 2022, I found myself talking to my colleague and friend Dr.Peter Edwards about modernist composer György Ligeti's upcoming 100-year birthday. We soon discovered that we had a mutual fascination for _Poème Symphonique_, his composition for 100 mechanical metronomes, and started to discuss the prospect of performing it. After discovering how expensive it is to buy 100 mechanical metronomes, our conversation ended by questioning whether it would be possible to digitally model the synchronization behavior that happens between the metronomes in the piece in software.

This topic was so interesting to me that I spent a great deal of time after my conversation with Peter researching algorithms and models for synchronizing oscillators in the digital audio realm. Eventually, my curiosity led me to design a system to perform a version of Poème Symphonique digitally. My system combines some custom-built MaxMSP (Max) software and state-of-the-art machine-learning tools for realtime audio processing.

This post shares my process, describing some backstory and detailing the software development and execution of my digital version of Poème Symphonique, Un Poème Symphonique Numérique. To see a full demo performance, visit the bottom of the post for a video link.
...
For some time, I have been interested in machine-learning libraries for Max designed for realtime audio. In particular, I've wanted to explore libraries like <MyLink href="https://github.com/rconstanzo/sp-tools">SP-tools</MyLink> that give users the ability to build corpora of sounds and process them in realtime. I decided to use SP-tools for my project to design an interesting sound engine that used clustering techniques on drum machine audio corpora. I started by hunting likable sounds, collecting two 100-sample datasets of clap and clave sounds from my large bank of drum machine sounds. After, used my datasets to create SP-tools audio corpora based on MFCC audio frames and filters for onset, RMS, and similar descriptors.
