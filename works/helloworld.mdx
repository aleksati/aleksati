...
It was important for us that this wifi sonification concept was understood fairly quickly by audience members without us having to compromise too much on artistic qualities. We wanted the audio aesthetic and sonification to reflect the hidden and sporadic qualities of wireless networks. This resulted in a fairly basic synthesis that was mostly based on low-frequency sounds, with added mysterious qualities.

The wifi traffic rate, packet lengths, and IP addresses all controlled aspects of the audio. For instance, the traffic rate was directly related to the intensity and density of the sound (a technique often known as audification of data). There were also links between network packet lengths and audio amplitude, as well as IP address and frequency content, to name a few.
