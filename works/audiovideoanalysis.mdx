...
AudioVideoAnalysis a standalone application for realtime OpenGL rendering of video motiongrams and audio spectrograms, part of the <MyLink href="https://www.uio.no/ritmo/english/research/labs/fourms/downloads/software/musicalgesturestoolbox/mgt-max/">Musical Gestures Toolbox for MaxMSP</MyLink> (MGT), created by Alexander Refsum Jensenius for the <MyLink href="https://www.uio.no/ritmo/english/research/labs/fourms/">RITMO FourMS lab</MyLink> at the University of Oslo in the early 2000s.

In 2019, I was assigned to update and refurbish AudioVideoAnalysis, one of the larger MGT applications. This post takes a quick look at AudioVideoAnalysis v2.0.
