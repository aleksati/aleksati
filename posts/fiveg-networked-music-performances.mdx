...
summary: "Me and a colleague teamed up with Telenor Research and did some experiments to see if it's possible to play music together over 5g. Here are the preliminary results."
---
...
Playing music over the network is highly challenging because of exceptionally high demands for low latency and fast communication. In fact, research tells us that the ideal roundtrip latency for synchronous NMPs is between 25-50ms.
