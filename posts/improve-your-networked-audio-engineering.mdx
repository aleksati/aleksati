...
type: "post"
summary: "During my time at UiO, I have organized over a dozen networked music performances (NMPs). In my experience, the success of a telematic event depends on the technician's familiarity with networked audio engineering, a field that is quite different from the usual concert tech. In my latest blog post, I provide some steps and strategies to improve the technical workflow and quality of your NMPs."
---
...
In this post, I provide some steps and strategies to improve the technical workflow and quality of NMPs from an audio engineering standpoint. These simple pointers are in no way comprehensive, nor particularly thorough, but I believe they can help navigate the complicated and often stressful environments of networked audio engineering.
