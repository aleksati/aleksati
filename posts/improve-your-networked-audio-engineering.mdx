...
type: "post"
summary: "Through my work at the University of Oslo, I have organized dozens of networked music performances since 2019. In my experience, the success of a telematic event is often determined by the technician's familiarity with networked audio engineering. In this post, I provide some steps to improve the technical workflow and quality of your NMPs."
---
...
As a lecturer and engineer at the University of Oslo, Department of Musicology, I have organized a dozen NMPs since 2019. In my experience, the success of a telematic event is often determined by how well the technicians are familiar with networked audio engineering context. Although latency is the most significant factor, it's often attention to specific issues, like noisy signal chains, sub-par routing schemes, ineffective troubleshooting, bad communication, and time management, that separate good NMPs from great NMPs.

In this post, I provide some steps and strategies to improve the technical workflow and quality of your NMPs. These simple pointers are in no way comprehensive, nor particularly thorough, but I believe they can help navigate the complicated and often stressful environments of networked audio engineering.
