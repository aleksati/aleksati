...
<ol>
  ...
  <li>
    <MyLink href="#ableton-live-setup">
      Ableton Live and Virtual Midi Setup
    </MyLink>
  </li>
  <li>
    <MyLink href="#config-and-mapping">Config and Mapping</MyLink>
  </li>
  <li>
...
<MyImage
  ...
  captio="By associating specific tracks with specific scenes in Ableton Live, I can navigate complex live sets using very few controls."
/>
...
In Ableton, you have to make sure you have the amount of scenes and tracks correspond to the scene_config in the python code.

Arrange tracks and scenes.

<h1 id="ableton-live-setup">Midi Setup</h1>
To communicate between the Python rtmidi and Ableton Live, we to setup a designated
port on our virtual midi driver.

<h1 id="config-and-mapping">Config and Mapping</h1>
...
The source code of my system is open source and available on my <MyLink href="https://github.com/aleksati/ableton-navigation-system">GitHub page</MyLink>.
