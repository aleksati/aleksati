...
type: "post"
summary: "Thanks to modern browsers and open-source coding libraries, creating audio-visual art on the Web is easier than ever. In this post, I share some examples of how to enrich data visualizations with model-based sonification in a browser using the p5js library."
---
