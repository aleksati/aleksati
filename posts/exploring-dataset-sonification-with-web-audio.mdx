...
So there you have it, three examples of how we create model-based sonification systems with the p5js coding library to help navigate and explore Big data on the Web. More specifically, my examples have explored how to use audio to augment traditional visual 2D plots in a web browser, exploring how sonification can help us to reveal greater dimensionality of datasets in realtime.

To date, libraries like p5js are great for prototyping interactive applications for the web. They're easy-to-use, compatible, widely used, and audio-visually robust.

From my experiences,
Downsides...
might be slow, network dependent.
hard to code usable systems for production. more as prototyping tools. art projects than robust analysis software.

Although this might change over time, I think the principles stay. should be helpful(!), aid, consistent.
great for accessibility.
interactive stuff.

Be sure to check out my github page for the full source code.

complimenting visual displays with
sonification applications with complex data-driven sound enginges
can be great,
...
If I were to take my orb example one step further, I would experiment with adding more oscillators to each orb. Specifically, I think I would try to add a new sound for every position of the orbs to try to sonically trace their journey as they move "through time", like a Sound Snake. Or something similar.
