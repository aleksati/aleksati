...
type: "post"
summary: "Me and a collegue teamed up with Telenor Research to see if it's possible to play music together over next generation 5G networks. Here are the preliminary results from our first audio experiments on 5G."
---
...
2. <MyLink href="#5g-experiments">5G Experiments</MyLink>
...
On the software side, We just needed something that could reliably and efficiently tramsit uncompressed stereo audio over the network. We thought about using other software, such as Lola or Sonobus, but settled on using <MyLink href="https://www.jacktrip.org">JackTrip</MyLink> from the Jack-audio connection kit as our main transmission software. Jacktrip is lightweight, fairly agnostic about network conditions, and works well cross-platform. Just what we needed.
