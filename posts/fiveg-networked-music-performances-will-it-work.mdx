...
To transmit audio back and forth, we used custom <MyLink href="https://github.com/MCT-master/NMP-Portable-Kits/wiki">NMP hardware kits</MyLink>, designed specifically for NMP education and research at IMV. These hardware bundles are designed specifically for ultra-low-latency AV transmission, given they have the right network conditions and software.

We used the Jack-audio connection kit (<MyLink href="https://www.jacktrip.org">JackTrip</MyLink> and Qjack) as our transmission software to send uncompressed audio over the network.
