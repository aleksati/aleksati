...
date: "2023-03-10"
keywords: ["audio", "live", "ableton", "python", "midi"]
  ...
  <ol>
    ...
    <li>
      <MyLink href="#skipping-audio-tracks">
        Skipping Audio Tracks with Generators
      </MyLink>
    </li>
    <li>
...
<h3 id="scene_config">scene_config</h3>
...
<h3 id="skipping-audio-tracks">Skipping Audio Tracks with Generators</h3>
