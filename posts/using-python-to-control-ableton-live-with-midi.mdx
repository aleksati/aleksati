...
One of the greatest things about Live as a DAW is its rich midi capabilities and visual design, enabling control of just about anything from anywhere. In early 2023, I ended up exploring these control capabilities in detail while building a new liveset for my band. I needed a way to navigate complex Live sessions with as few midi controls as possible. The frustration resulted in a system that helps me navigate sessions more efficiently by treating the Live interface like a 2D matrix.
...
However, navigating Live's visual interface like a 2D structure is not uncommon.
In fact, most midi-controllers afford this kind of behavior for traversing sample
spaces and audio effects. So most Live performers are familiar with it.
