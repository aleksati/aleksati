...
1. <MyLink href="#introduction">Introduction</MyLink>
...
In this post, I share the design, important code snippets, and general Live specs used to build this system for my liveset.
