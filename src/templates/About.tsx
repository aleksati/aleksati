    ...
    <div className="grid grid-cols-2 gap-4 md:gap-16 items-start">
      ...
      <div className="space-y-4 col-span-2 md:col-span-1">
        ...
        <p>
          ...
          with a particular focus on audio programming and networked sound.
          Outside of work, I play drums, produce music with friends, and try to
          read a little every day. This website is both a portfolio and a blog,
          a place where I share projects and write about music technology and
          related explorations.
        </p>
        <p>
          Stay updated on my posts by subscribing to my RSS feed from the
          menubar. You can also reach out by leaving comments under each post.
        </p>
        ...
        <div className="flex flex-col space-y-2 items-center md:items-start">
          <p className="font-bold text-lg">Teachings</p>
