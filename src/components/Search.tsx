...
const Search = () => {
 ...
 { !query ?     
      ...
      <input
        className="border text-base border-gray-200 dark:border-gray-600 bg-primary-light dark:bg-primary-dark rounded-md h-14 lg:h-10 w-full"
      ...
      {results?.length ? (
        <div className="absolute w-full max-h-200 overflow-y-auto mt-2 rounded-md bg-primary-light dark:bg-primary-dark border-x border-t border-gray-200 dark:border-gray-600 shadow-lg">
