---
title: "Poème Symphonique Numérique: Recreating Ligeti's 100 metronomes in software"
date: "2024-04-05"
keywords: ["audio", "art", "software", "machine-learning", "dsp", "rhythm-and-time", "max", "kuramoto", "synchronization", "programming", "realtime", "mapping", "data-knot", "algorithms"]
type: "project"
summary: "Modernist composer György Ligeti would have been 100 years in 2023. To celebrate, I dediced to create a version of his famous 'Poème Symphonique for 100 metronomes' in Max, using the Kuramoto model for synchronization and a real-time ML-based sound engine. Read more about my process, see the code and listen to the result here!"
---

{/* 
# Poème Symphonique Numérique: Recreating Ligeti's 100 metronomes in software
*/}
