...
type: "project"
summary: "'Hello World' is a sound-sculpture made of burned drywall paper tape, methyl cellulose, aluminum flashing, bluetooth transducers, concrete and steel rods. The sculpture is made by artist Henrik Nordahl, but I was asked to make it sing, i.e generate sound and vibrations based on the WiFi traffic on-site. In this post I share what we did and how it turned out."
---
...
<MySlideshow priority={true} width={750} imgs={["helloworld-1.jpg", "helloworld-2.jpg", "helloworld-3.jpg", "helloworld-4.gif"]}  padding={false}/>
...
My contributions were purely to the audio of the sculpture. My mission was to ensure that the structure sonically reacted to nearby wifi traffic using Bluetooth transducers in combination with Max and Python software.
