---
title: "Dataset Generator for Musical Devices (DGMD)"
date: "2024-07-16"
keywords: ["audio", "machine-learning", "research", "software", "programming", "max", "javascript", "midi", "realtime", "mapping"]
type: "project"
summary: "the Dataset Generator for Musical Devices (DGMD) is software that can generate datasets from audio effects specifically for machine-learning tasks. This post takes a closer look at the DGMD software, including links to tutorials and download pages. Original post by Stefano Fasciani."
---
...
{/* 
2. <MyLink type="toc" href="#what-is-dgmd">What is DGMD</MyLink>
3. <MyLink type="toc" href="#functionality">Functionality</MyLink>
4. <MyLink type="toc" href="#video-tutorials">Video Tutorials</MyLink>
   1. <MyLink type="toc" href="#short-presentation">Short Presentation</MyLink>
   2. <MyLink type="toc" href="#full-video-tutorial">Full Video Tutorial</MyLink>
   3. <MyLink type="toc" href="#demo-with-external-audio-effect">Demo with External Audio Effect</MyLink>
5. <MyLink type="toc" href="#download-link-and-resources">Download Link and Resources</MyLink> 
---
*/}
