...
date: "2024-08-06"
keywords: ["audio", "latency", "software", "realtime", "dsp", "engineering", "analysis", "research", "data-science", "programming", "max", "javascript", "mapping"]
type: "project"
summary: "A quick look into Audio Latency Examiner (ALEX); my new all-in-one software tool for measuring and batch collecting audio latency data from different software and hardware scenarios. The app is open-source and free to download, available for both Windows and Mac."
---
...
<MyImage width={750} src="alex-ui-main.png" alt="main GUI of the audio latency examiner" padding={false} />

As a connoisseur of networked music, latency is something I care about more than usual. But accurately measuring the audio latency of a software or hardware system is challenging, both in a controlled classroom setting and in "the field". Many variables come into play, and there is usually a need for several devices to collect and measure the data from start-to-end. Because of this, I've always missed a simple software solution capable of measuring and collecting large amounts of audio latency data from different hardware/software scenarios, all-in-one. That’s why I decided to make the Audio Latency Examiner (ALEX, for short). ALEX is a software tool that provides an easy-to-use and intuitive interface for measuring audio latency for many different use-cases, but which still retains enough advanced functionality to enable precise, scientific, and methodical measurement practices. Exactly what I’ve been missing.
...
# Monitoring inputs and latency data
...
# Download link and how to report issues
