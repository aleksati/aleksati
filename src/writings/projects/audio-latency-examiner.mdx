...
type: "project"
summary: "A quick look into Audio Latency Examiner (ALEX); my new software tool that can batch collect audio latency data from both musical software and hardware devices. The app is open-source and free to download, available for both Windows and Mac."
---
