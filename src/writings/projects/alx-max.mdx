---
title: "My tiny Max/MSP library for audio, video and data processing - alx.max"
date: "2023-10-21"
keywords: ["max", "software", "audio", "video", "dsp", "analysis", "programming", "jitter", "opengl", "realtime", "mapping", "synchronization", "kuramoto"]
type: "project"
...
---
{/* 
# My tiny Max/MSP library for audio, video and data processing - alx.max
*/}
...
<MyImage src="alx-ksync.png" alt="alx.ksync object demonstration" caption="Use alx.ksync to couple and synchronize oscillators with the kuramoto model. Add how many oscillators you want to sync, provide the frequency and on/off state for each oscillator and your done. Finally, turn the K-value to increase coupling and initiate syncronization" />
