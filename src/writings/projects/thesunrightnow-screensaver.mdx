...
type: "project"
summary: "The Sun Right Now is my new desktop screensaver that displays colorful 4K images of the sun in a cool slideshow. The images are real-time and retrieved directly from the NASA SDO, a satellite observatory currently orbiting Earth. In this post, I share how the app works and how you can use it yourself."
---
