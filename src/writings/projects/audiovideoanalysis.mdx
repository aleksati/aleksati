...
date: "2022-11-11"
keywords: ["software", "audio", "video", "rhythm-and-time", "max", "analysis", "dsp", "motion", "jitter", "opengl", "realtime", "research", "programming", "ritmo", "uio"]
type: "project"
...
AudioVideoAnalysis a standalone application for realtime rendering of video motiongrams and audio spectrograms, one of the larger applications part of the <MyLink href="https://www.uio.no/ritmo/english/research/labs/fourms/downloads/software/musicalgesturestoolbox/mgt-max/">Musical Gestures Toolbox for Max</MyLink> (MGT) created by Alexander Refsum Jensenius for the RITMO FourMS lab at the University of Oslo in the early 2000s.
