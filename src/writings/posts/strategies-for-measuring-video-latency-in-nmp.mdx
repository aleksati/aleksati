---
title: "Strategies for Measuring Video Latency in Networked Music and Dance Performances"
date: "2025-03-22"
keywords:
  [
    "nmp",
...
type: "post"
summary: "Measuring video latency in networked music performances (NMP) is stressful and hard. There is usually little time and resources at hand, and on-site conditions often alot vary from controlled lab-scenarios and research setups. In this post, I share a few practical methods for measuring video latency that guarantee precise and reliable data collection in the field, developed from years of professional experience."
---
...
My previous post was all about audio latency and how we can measure audio latency in real-world networked performance contexts. Now, let's focus on video. Even though we are more tolerant of video delays than audio delays, video latency has a huge impact on stage aesthetics, _flow_ and audio-video synchronization of networked performances.
...
Setting up networked performance systems is usually pretty hectic with many concerns and very little time to manage them. Having a detailed plan can therefore ensure precision and scientific validity. And the better the plan is, the less you have to think and stress when the iron is hot. Below I have sketched out an example plan with five individual steps that, when followed, will give accurate and precise video latency measurements.
