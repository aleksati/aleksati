...
type: "post"
summary: "Measuring video latency in networked music performances (NMP) is stressful. There is little time and resources at hand, and on-site conditions often vary alot from controlled research setups. In this post, I share a few practical methods and strategies for measuring video latency that guarantee precise and reliable data collection in the field, developed from years of professional experience."
---
