...
type: "post"
summary: "Two years ago I recreated György Ligeti's 'Poème Symphonique for 100 Metronomes' in software. For that to work, I had to build my own audio version of the Kuramoto model so that the metronomes would sync to each other. I have written a post about this project, but looking back, I feel like my Kuramoto model software deserves a post of its own. A post describing the process and how I designed it as a dynamic multi-channel audio object in Max, able to sync 100+ oscillators on the fly."
---
