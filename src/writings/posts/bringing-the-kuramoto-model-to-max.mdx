...
type: "post"
summary: "Two years ago, while recreating Ligeti's 'Poème Symphonique for 100 Metronomes' in software, I had to build my own audio/DSP-version of the Kuramoto model to be able to sync all the metronomes. I have written a post about the project, but looking back, I feel like my Kuramoto model software deserves a post of its own. A post describing the process and how I designed it as a dynamic multi-channel audio object in Max/MSP, able to sync 100+ oscillators on the fly."
---
