---
title: "Using the Kuramoto Model to Build a Multi-Channel Audio Synchronizer in Max/MSP"
date: "2026-01-04"
keywords: ["audio", "max", "synchronization", "dsp", "kuramoto", "software", "programming", "realtime", "algorithms"]
type: "post"
summary: "Two years ago I recreated György Ligeti's 'Poème Symphonique for 100 Metronomes' in software. For that to work, I had to build my own audio version of the Kuramoto model so that the metronomes would sync to each other. I have written a post about this project, but looking back, I feel like my Kuramoto model software deserves a post of its own. A post describing the process and how I designed it as a dynamic multi-channel audio object in Max/MSP, able to sync 100+ oscillators on the fly."
---

{/* 
# Using the Kuramoto Model to Build a Multi-Channel Audio Synchronizer in Max/MSP
*/}
