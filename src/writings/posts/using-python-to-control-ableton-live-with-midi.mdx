...
date: "2023-07-10"
keywords: ["python", "ableton", "mapping", "midi", "performance", "realtime", "audio", "programming", "synth"]
type: "post"
...
<MyImage src="abletonmidi-overview1.gif" alt="overview of my setup to navigate Ableton Live using python" caption="Only using one button(!) on my MIDI-controller to jump between tracks and one button to iterate over scenes."/>
...
1. <MyLink type="toc" href="#overview-and-requirements">Overview and Requirements</MyLink>
2. <MyLink type="toc" href="#python-setup">Python Setup</MyLink>
3. <MyLink type="toc" href="#live-setup">Live Setup</MyLink>
4. <MyLink type="toc" href="#concluding-thoughts">Concluding Thoughts</MyLink>
...
<MyImage src="abletonmidi-live-overview.jpg" alt="overview of my setup to navigate Ableton Live using python" caption="Live's session view is an interface designed and made for live performance. Highlighted in red are scenes and tracks that together can be perceived as a 2D matrix structure." />
...
<ul>
  ...
  <li>a Python environment with the <MyLink href="https://pypi.org/project/python-rtmidi/">rtmidi</MyLink> library installed</li>
  <li>A virtual midi driver</li>
  <li>Ableton Live 11 (++)</li>
</ul>

<MyImage src="abletonmidi-system-diagram.png" alt="An overview diagram of my setup." />
...
<MySlideshow imgs={["abletonmidi-ableton-midi-mapping.png", "abletonmidi-ableton-midi.png"]} captions={["Making a `daw-midi-mapping.py` is recommended when your Ableton setup is tighly coupled with Python variables.", "Configure the midi settings to listen for data from python."]} />
