...
type: "post"
summary: "Measuring the audio latency of networked music systems is a complicated procedure (often more than you might think) where you have to control and navigate complex technical setups with many moving parts and little time at your disposal. In this post, I write about solid strategies and share good practical ways to measure audio latency in real-world networked music systems."
---
