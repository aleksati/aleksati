---
title: "Measuring Latency in Networked Art Performances, Part 1: Audio"
date: "2024-08-08"
keywords: ["nmp", "audio", "latency", "realtime", "network", "engineering", "synchronization", "analysis", "research", "telematic", "performance"]
type: "post"
summary: "Measuring the audio latency in networked music and dance systems involves navigating complex technical setups in mulitple locations at once, usually on a tight schedule. In this post, I write about solid strategies and share good practical ways to measure audio latency in real-life networked performances."
---
