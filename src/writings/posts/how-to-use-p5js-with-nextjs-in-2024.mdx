...
date: "2024-02-03"
keywords: ["p5js", "audio", "typescript", "nextjs", "web", "react", "programming", "javascript", "visuals", "nodejs"]
type: "post"
...
2. <MyLink href="#importing-p5-and-p5-sounds">Importing p5 and p5-sounds</MyLink>
3. <MyLink href="#alternative-p5-sounds-import">Alternative p5-sounds Import</MyLink>
4. <MyLink href="#building-audio-apps-with-p5-sounds">Building Audio Apps With p5-sounds</MyLink>
5. <MyLink href="#full-code-and-working-example">Full Code and Working Example</MyLink>
6. <MyLink href="#references-and-inspirations">References and Inspirations</MyLink>
