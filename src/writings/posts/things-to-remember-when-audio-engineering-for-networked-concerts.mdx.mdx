---
title: "Things to Remember when Audio Engineering for Networked Concerts"
date: "2023-12-28"
keywords: ["network", "audio", "engineering", "nmp", "analysis", "realtime", "latency", "research", "telematic", "performance"]
type: "post"
summary: "Doing live sound for a distributed concert between two remote locations over the network is very different from an average concert setting. Having to mix different stages while also handling the networking layer can be a real challenge, especially when it's showtime and the pressure is on. In this post, I share some useful steps and strategies that can help guide your networked audio engineering practice."
---

{/* 
# Things to Remember when Audio Engineering for Networked Concerts
*/}

After the COVID-19 pandemic, there's been a surge of products that seek to facilitate better musical collaboration over the internet, offering everything from all-in-one hardware solutions, such as <MyLink href="https://elk.audio">Elk</MyLink> or <MyLink href="https://www.songpark.com/company">Songpark</MyLink>, to new software using tech like <MyLink href="https://webrtc.org/">WebRTC</MyLink> and WebAssembly. What these products offer is usually better interfaces, slightly lower hardware latencies, modernized web integration, audio/video/network optimization options, and even compatibility with future networks like 5G. However, adequate tech is only one of many parts necessary to conduct successful networked music performances (NMP). Zooming out, NMPs require us to radically change our audio engineering practice to accomodate a whole new musical environment.
...
{/* 1. <MyLink type="toc" href="#nmp-mixer-requirements">NMP Mixer Requirements</MyLink>
2. <MyLink type="toc" href="#first-contact-and-communication-setup">First Contact and Communication Setup</MyLink>
3. <MyLink type="toc" href="#fine-tuning-the-audio-to-suit-the-network">Fine-tuning the Audio to Suit the Network</MyLink>
4. <MyLink type="toc" href="#soundchecks-and-the-importance-of-gain-staging">Soundchecks And The Importance Of Gain-staging</MyLink>
5. <MyLink type="toc" href="#summary">Summary</MyLink>
6. <MyLink type="toc" href="#references">References</MyLink> 
---
*/}
...
<MyImage src="nmp-quality-mixer-req.png" alt="diagram showing how many mixes a basic dual-audience NMP would need." caption="As opposed to normal concerts, NMP audio engineers have to manage and incorporate more mixes into their workflow." />
...
<MyImage src="nmp-quality-laptop.png" alt="diagram showing how to connect talkback, network mixes via an AD/DA to the network." caption="Connect the talkback and network send channels in parallel through a good audio interface for a stable and effective communication system." />
...
<MyImage src="nmp-quality-quality-check.png" alt="diagram showing how to send a reference signal through your entire NMP chain to monitor the audio (and network) quality." caption="Send a reference signal through your entire NMP chain to monitor the audio (and network) quality." />
