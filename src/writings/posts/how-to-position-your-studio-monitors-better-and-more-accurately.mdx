---
title: "How to Position Your Studio Monitors Better and More Accurately"
date: "2024-09-29"
keywords: ["audio", "engineering", "studio", "acoustics"]
type: "post"
summary: "Improving the positioning of your studio monitors can significantly improve the sound quality of your studio. In this post, I share an easy and practical way to find optimal placements for your studio monitors with just some basic tools and a little know-how."
---

The golden rule of studio monitor placement dictates that there should be an equilateral triangle between your studio sweet spot and your stereo-pair monitors where all angles and sides are congruent. Eyeballing this setup is pretty commonplace as most audio engineers learn and adapt to the unique characteristics of their own studio places to improve their game. 

However, improving the position of your studio monitors can significantly improve the sound quality of your studio. In this post, I share an easy and practical way to find optimal placements for your studio monitor with just some simple tools and a little know-how.
...
To accurately place an item in a 3D space, we need to know the azimuth (left-right), elevation (height) and distance to the item from a fixed location. In a sound studio context, we already know the optimal height of the speakers as they should horizontally align the tweeter drivers with the engineer's ears while sitting near the studio sweet spot. This means we only need to figure out the azimuth and distance to set up our studio monitors. For this, we need only two basic tools, 1) a protractor sheet and 2) a laser measurement device. 

A protractor is a cheap and reliable tool to measure the angular degrees of items in a physical space. For measuring speaker setups, I've found it best to make a custom protractor from a printed-out chart stuck to a square piece of thick cardboard. The cardboard adds some structural integrity and gives the device a steady surface to attach in different places. Also, to create a better measurement interface, I draw a cross with straight lines through the 0-180° and 90-270° angles out to the edges of the cardboard, as a finishing touch. 

Creating these kinds of measurement tools is pretty commonplace in many spatial audio communities. Artists, composers and technologists in these fields often use different speaker setups to showcase their work and need reliable, cheap and accurate tools to manage speaker positioning.
...
Next, place the measurement device at the very center of the protractor facing forward so that their edges are perpendicular. Now, adjust the laser's and stand's position so that the laser dot hits both 0° on the protractor and the center of your studio's front wall. It's wise to spend some time defining what the front center point of your studio is, from the vantage point of your desired sweet spot, as this will be the final reference point for the speaker positioning. To cross-check that the protractor is aligned with both the studio center and 0° on the protractor, I usually just place my hand at the edge of the protractor in front of the laser to catch the azimuth-degree rotation and remove my hand again to see if the laser hits the studio front center. When the laser is properly aligned, add some masking tape on the floor to mark the exact position of the stand.
