...
The golden rule of studio monitor placement dictates that there should be an equilateral triangle between your studio sweet spot and your stereo monitors where all angles and sides are congruent. For studio engineers, it's pretty common to eyeball this setup as it's often considered more important to learn and adapt to the unique characteristics of specific studio spaces and monitor setups. However, by improving the positioning of your studio monitors you can potentially improve the listening quality in your studio by a whole lot. 
