...
type: "post"
summary: "Last year, I led several workshops on audio networking with OSC, focusing on using timestamps and synchronization between musical devices. In this post, I refine my workshops into a practical, step-by-step guide to developing your own synchronization scheme with OSC, using a technique called Forward Synchronization in Python and Pure Data."
---
...
In this post, I attempt to distill my workshop experiences into a practical, step-by-step guide for building your own syncronization scheme in Python and Pure-data. Over four steps, we will develop a bidirectional, scalable, and dynamic approach to synchronizing musical devices using OSC and a strategy called Forward Synchronization. Included below are detailed code examples and links to the full codebase.
