...
I've teste on playsound v.1.2.2 and python-osc v.1.9.3. Playsound is trickier with the latest versions but python-osc seems to work fine still (january 2026).
