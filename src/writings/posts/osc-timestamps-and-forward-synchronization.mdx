...
TODO -> 
* Table of content in navbar.
* Comment all Table of contents in posts.
* Publish OSC post , I can maybe delete some of the OSC definition. Have in two places.
...
# What is Forward Synchronization?
...
<MyImage
  ...
  alt="The anatomy of a OSC stream. Image from Schmeder & Freed, 2008."
  caption="The anatomy of a OSC stream. Image from Schmeder & Freed, 2008."
/>
...
# Step 2 - Network Controlled Metronome
...
<MyImage
  ...
  caption="Yellow parts encapsulate new code from the previous step."
/>
...
```Python
# Step 2 - Network-Controlled Metronome server
from pythonosc import dispatcher, osc_server
...
```Python
# Step 2 - Network-Controlled Metronome client
from pythonosc import udp_client
from pythonosc import osc_bundle_builder, osc_message_builder
import time
import threading
...
# Step 3 - OSC Timestamp Controlled Metronome
...
```Python
# Step 3 - OSC Timestamp Controlled Metronome client
from pythonosc import udp_client
from pythonosc import osc_bundle_builder, osc_message_builder
import time
import threading
