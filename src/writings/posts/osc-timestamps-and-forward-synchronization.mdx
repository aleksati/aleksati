...
type: "post"
summary: "OSC is a high-resolution protocol (64-bit) for sending messages between musical devices, similar to MIDI (8-bit). Last year, I led some workshops on OSC focusing on its unique audio networking capabilities. In this post, I distill my workshops into a written step-by-step guide, showing how to use OSC Timestamps and a technique called Forward Synchronization to effectively sync musical devices in Python and Pure Data."
---
