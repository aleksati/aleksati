...
type: "post"
summary: "Last year, I led a few workshops on audio networking with the OSC protocol. In this post I channel my workshop experiences into a written step-by-step guide on how synchronize musical devices using OSC Timestamps and technique called Forward Synchronization, in both Python and Pure Data."
---
