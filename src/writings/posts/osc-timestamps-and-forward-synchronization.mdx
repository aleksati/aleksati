...
type: "post"
summary: "OSC is a fairly new and promising protocol for sending messages between musical devices, similar to MIDI. Last year, I led a series of workshops on some of the advanced synchronization possibilities that arise with OSC. In this post, I distill my workshops into a written step-by-step guide, showing how to use OSC Timestamps and a technique called Forward Synchronization to effectively synchronize musical devices between Python and Pure Data."
---
