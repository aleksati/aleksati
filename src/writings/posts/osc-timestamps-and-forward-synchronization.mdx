...
type: "post"
summary: "OSC is a protocol for sending messages between musical devices, an alternative to MIDI. Last year, I led some workshops on OSC and some of its unique audio synchronization capabilities. In this post, I distill my workshops into a written step-by-step guide, showing how to use OSC Timestamps and a technique called Forward Synchronization to effectively synchronize musical devices between Python and Pure Data."
---
