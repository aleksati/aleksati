...
type: "post"
summary: "During a recent project, I fell into an unexpected rabbit hole of Sudoku solvers, recursion, and integer partitions. What started as a specific problem about musical groove turned into an interesting exploration of problem-solving itself, eventually resulting in my new Max object that shape rhythmic patterns using restricted integer partitions. This is the story of how I got there, and why I find these kinds of problem-solving adventures so darn interesting."
---
