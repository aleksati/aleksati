...
type: "post"
summary: "During a recent reserach project, I fell into an unexpected rabbit hole of Sudoku solvers, recursion, and integer partitions. What started as a specific problem about musical groove turned into an interesting exploration of problem-solving itself, eventually resulting in my new Max object that can shape interesting rhythmic patterns using restricted integer partitions. This is the story of how I got there, and why I find these kinds of problem-solving adventures so darn interesting."
---
...
There you have it. If you made it this far, you've read my story about how a recent work-related project led me down a rather unexpected rabbit hole involving Sudoku solvers, recursion, and integer partitions. Also, what started as a fairly specific problem about musical groove became an interesting exploration of how I approach problems in the first place.
