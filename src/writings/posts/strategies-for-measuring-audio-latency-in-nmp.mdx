...
type: "post"
summary: "Measuring audio latency in networked music performances (NMP) is stressful and hard. There is usually little time and resources at hand, and on-site conditions often alot vary from controlled lab-scenarios and research setups. In this post, I share a few practical methods for measuring audio latency that guarantee precise and reliable data collection in the field, developed from years of professional experience."
---
