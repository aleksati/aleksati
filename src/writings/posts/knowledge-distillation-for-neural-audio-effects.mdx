...
type: "post"
summary: "I was recently involved in a research project that examined if a compression technique called Knowledge Distillation could be used to make neural audio effects smaller and more efficient. In this post, I walk through our experiments and show how we were able to distill knowledge from larger audio distortion models to enhance the performance of smaller models. Also included are VST downloads, audio examples, source code and more."
---
