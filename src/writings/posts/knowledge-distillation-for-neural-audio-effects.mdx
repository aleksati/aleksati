...
type: "post"
summary: "Making neural networks smaller without affecting their accuracy is hard. Knowledge Distillation (KD) is a fairly new technique where larger models are used to improve the performance of smaller models. In this post, I walk through my recent research project where we examined if KD could be used to enhance audio effects (VSTs) built with neural networks. And the short answer is Yes! Also included are VST downloads, audio examples, source code and more."
---
