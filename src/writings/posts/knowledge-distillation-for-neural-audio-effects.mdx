...
type: "post"
summary: "Making neural networks smaller without affecting their accuracy is very difficult. Knowledge Distillation (KD) is a fairly new technique for this, where larger models are used to train smaller models. In this post, I walk through a recent research project of mine where we examined if KD could be used to reduce the size of audio effects (VST) built with neural networks. And the short answer is yes, it can!"
---
