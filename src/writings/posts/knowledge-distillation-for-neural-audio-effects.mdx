---
title: "Compressing neural audio effects (VSTs) with Knowledge Distillation"
date: "2025-12-21"
keywords: ["audio", "fx", "machine-learning", "vst", "research", "python", "realtime", "engineering", "algorithms", "uio"]
type: "post"
summary: "Finding ways to make neural networks smaller without affecting their accuracy is a hard and important problem. In 2025, my colleague and I examined whether a technique called knowledge distillation could be used to make neural audio effects (VSTs) smaller and more efficient. And the short answer is yes, it can! In this post, I go over the key details of our research and present some interesting experiences from the first-ever international conference on AI and Machine Learning for Audio."
---

{/* 
# Compressing neural audio effects (VSTs) with Knowledge Distillation
*/}

<MyImage src="kd-audio-fx-main.jpg" alt="kd-audio-fx-main.jpg" padding={false} />

Having a good teacher can change your life. When I was a teenager, I ended up taking theoretical maths at my local high school thought by a man called Roger. I didn't do very well in this class. In fact, I was failing. Hard to say why, for sure, but I know that I didn't study or care much about maths at that time. What I do know, however, is that I loved Roger's classes. And I loved Roger. He was open, funny, knowledgeable in the best ways, and a great teacher overall. It was clear that he loved maths and wanted to share his passion with us. It was because of this that I stayed. I stayed for so long that he actually took me aside one day and asked me to switch to a simpler programme, if I wanted to graduate. Looking back today, it's obvious that I was inspired by Roger, but I don't think we were the best teacher-student combo. I have been thinking more about this recently, about what it means to be a good student and teacher.

I am currently sitting in a hot conference room at Queen Mary University College in London, listening to a talk about AI ethics at the first-ever international conference on AI and Machine Learning for Audio, hosted by the Audio Engineering Society in September 2025 (called AES AIMLA). I am here because I was involved in a research paper that got accepted here last spring that started in 2024 when my friend and former colleague (he is now elsewhere in the world) Riccardo Simionato asked me to help him explore whether neural audio effects, which are audio effects built with neural networks, could be made more efficient using a compression technique called Knowledge Distillation. With knowledge distillation, the inner workings of large neural networks called _teachers_ are transferred, or distilled, to smaller _student_ networks. Essentially, the students are taught by their teacher. 

Back in the conference room, the question in the air is about AI and how it will affect the music industry. An older gentleman man just raised his hand and confidently signaled the chair. Through a longer comments, the man argued that we might better understand the fate of AI in the music industry by looking to other similar technological advancements that have occured in the past. MP3 and online sharing were thought to be the end of the music industry as we knew it. There was a lot of criticism and huge concern about piracy, especially among artists. The reality, however, turned out to be less extreme. Of course the music industry changed a lot during this time, but the role of MP3 in the matter was less significant than expected. I later learned that the guy speaking actually was a central character to the development the MP3 codec sometime in the 80s and 90s. In other words, a legend in the field. The whole thing also reminded me of a graph I saw not long ago that depicted how the popularity of new technologies almost always tends to receede over time, that our expectations are almost always wrong. Might this be the case with AI as well? Are we currently at the very peak of the curve, waiting for the imminent fall? I don't know what the fate of AI will be, nor do I think the MP3-man has all the answers. 

The essential takeaway here is that it can be hard to find the right teachers in life. Knowing where to you will get the best and most truthful knowledge is difficult. And just finding a good source is not enough, you have to find someone that fits well with you and your situation, whether you're a high school student, a reseracher at an AI conference, or a neural network tying to be a better and smaller version of yourself.

In this post, I will take on the role as a teacher, presenting our knowledge distillation AES paper (which was the whole reason I was in London this September morning in the first place) to you! The post touches on central concepts in virtual-analog modeling and digital compression techniques, but focuses on explaining our experiments and results of using knowledge distillation to reduce the size of audio effects (VSTs) built with neural networks.
...
# Distilling the knowledge of neural audio effects 
...
# Building and training our distortion VST network
