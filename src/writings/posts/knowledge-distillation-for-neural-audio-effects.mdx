...
type: "post"
summary: "Making neural networks smaller without affecting their quality is a real challenge. Knowledge Distillation (KD) is a fairly new technique here, where knowledge from larger models are used to enhance the performance of smaller models. In this post, I walk through a recent research project I was involved where we examined if KD could be used to enhance real-time neural audio effects (VSTs). And the short answer is Yes! Also included are VST downloads, audio examples, source code and more."
---
