...
type: "post"
summary: "Making neural networks smaller without affecting their accuracy is difficult. Knowledge distillation is a fairly new technique for this, where larger models are used to train smaller models. In this post, I present a recent research project I was involced in where we examined if knowledge distillation could be used to reduce the size of audio effects (VST) built with neural networks. And the short answer is yes, it can!"
---
...
Back in the conference room, the question in the air is about AI and how it will affect the music industry. An older gentleman man raised his hand and confidently signaled the chair. The man argued that we might better understand the fate of AI in the music industry by looking to other similar technological advancements that have occured in the past. MP3 and online sharing were thought to be the end of the music industry as we knew it. There was a lot of criticism and huge concern about piracy, especially among artists. The reality, however, turned out to be less extreme. Of course, the music industry did change a lot in this time, but the point was that the role of MP3 in the matter was less significant than expected. I later learned that the guy who was speaking actually was central to the development the MP3 codec sometime in the last century. A legend in the field. Anyway, the mans comment reminded me of a graph I saw not long ago, a graph that depicted how the popularity of new technologies almost always tends to receede over time, and that our expectations are almost always wrong. I don't know what the fate of AI will be. But what I do know is that we have to be careful about where we get our information from and who we choose as our teachers, whether it's a high-school maths teacher, a retired MP3-entrepreneur, or from history itself. 

In this post, I assume the role of teacher, teaching you about our knowledge distillation AES paper (the whole reason I was in London this September morning in the first place). The post touches on central concepts in virtual-analog modeling and digital compression techniques, but focuses on our experiments using knowledge distillation to reduce the size of audio distortion effects (VSTs) built with neural networks. 
