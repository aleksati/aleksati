---
title: "Measuring Latency in Networked Art Performances, Part 2: Video"
date: "2025-03-22"
keywords:
  [
    "nmp",
...
type: "post"
summary: "Measuring the video latency in networked music and dance systems involves navigating complex technical setups in multiple locations at once, usually on a tight schedule. In this post, I write about solid strategies and share good practical ways to measure video latency in real-life networked performances."
---
...
In this post, I write about some strategies and practical ways to measure video latency in networked performance scenarios, inspired by recent research and developed from years of experience running networked music courses for the <MyLink href="https://mct-master.github.io/">MCT masters programme</MyLink> at the University of Oslo. Hopefully, this can guide you toward better and more scientific measurement practice.
...
<MyImage
  ...
  caption="One of the video latency measurement methods presented by Ubik and Pospíšilík involves clever filming of precision clocks to isolate a given measurement object in the signal chain. Source: Ubik and Pospíšilík, 2021."
/>

This general technique, and many others, was presented by Sven Ubik and Jiri Pospíšilík in their article from 2021, entitled **Video Camera Latency Analysis and Measurement**. But networked performances are chaotic endeavors, usually with limited time and resources allocated for scientific measurements. This makes using Ubik and Pospíšilík's method challenging to use off-the-shelf. Instead, we should use it as guidelines for building a measurement scheme more suitable for networked concert contexts. 

I prefer to modify Ubik and Pospíšilík's method by using different time-critical sources and measurement devices. For my sources, I usually switch out precision clocks for an easier and equally reliable option, namely hand-clapping. Dealing with precision clocks and high-framerate devices to capture digital numbers can be a real hassle in the field. Hand-clapping gives a surprising amount of accuracy and doesn't require any extra hardware. Of course, the accuracy will depend on what measurement camera is used. Smartphone cameras can be perfect measurement devices, if you can control and log the framerate (FPS). The more the FPS, the more accurate your measurements will be. 
...
<MyImage
  ...
  caption="Clapping is an excellent time-critical source that works well when measuring video latency in the field."
/>

In the end, experimenting with different techniques and practices is necessary to find a suitable method for the given context. But using scientifically-based techniques is always a good starting point. Then, the question simply becomes what kind of quality and accuracy you're after. The more simplifications and shortcuts you include, the lower the quality and accuracy you should expect from your experiments.
