---
title: "How to integrate p5js into Nextjs TypeScript Projects in 2024"
date: "2024-02-03"
keywords:
  [
    "p5js",
...
type: "post"
summary: "I use the p5js library to make little audio-visual widgets on my website all the time. Recently, I decided to redesign and update my p5 and p5-sounds implementation to support newer versions of p5, React, Nextjs (v14.1), and TypeScript. Click to read how I did it."
---
