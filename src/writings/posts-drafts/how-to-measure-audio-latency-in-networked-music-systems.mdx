...
3. <MyLink type="toc" href="#measurement-procedure">Measurement Procedure</MyLink>
   1. <MyLink type="toc" href="#step-1---verify-the-measurement-system">Step 1 - Verify The Measurement System</MyLink>
   2. <MyLink type="toc" href="#step-2---connect-the-music-system-to-the-measurement-system">Step 2 - Connect The Music System to The Measurement System</MyLink>
   3. <MyLink type="toc" href="#step-3---fine-tune-the-audio-quality">Step 3 - Fine-tune The Audio Quality</MyLink>
   4. <MyLink type="toc" href="#step-4---measure-the-latency">Step 4 - Measure The Latency</MyLink>
   5. <MyLink type="toc" href="#step-5---(extra)-measure-with-alternative-parameters">Step 5 (extra) - Measure With Alternative Parameters</MyLink>
4. <MyLink type="toc" href="#summary">Summary</MyLink>
5. <MyLink type="toc" href="#references">References</MyLink>
...
Another advantage of using specialized measurement software like ALEX is that it opens up the possibilities of measuring other audio devices, such as VST plugins and virtual audio drivers.
