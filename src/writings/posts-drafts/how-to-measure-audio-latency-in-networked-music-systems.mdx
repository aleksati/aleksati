...
<MyImage src="nmp-quality-quality-check.png" alt="diagram showing how to send a reference signal through your entire NMP chain to monitor the audio (and network) quality." caption="Send a reference sine tone through the NMP signal chain to monitor the audio (and network) quality." />
