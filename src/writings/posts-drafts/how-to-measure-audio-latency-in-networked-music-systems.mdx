...
<MyImage src="audiolatency-irl-nmp-1.png" alt="..." caption="..." />
...
<MySlideshow imgs={["audiolatency-diagram-loopback.png", "audiolatency-irl-loopback.png"]} captions={["... Real example in next image -->", "..."]} />
...
<MySlideshow imgs={["audiolatency-diagram-handyrec.png", "audiolatency-irl-handyrec.png"]} captions={["... Real example in next image -->", "..."]} />
...
<MySlideshow
  ...
  captions={["... Real examples in next images -->", "Testing using a Hall Research AD-340 Universal Audio Delay Processor as my measurement object.", "..."]}
/>
...
<MyImage src="audiolatency-diagram-soose.png" alt="..." caption="...(S)OOSE Delay" />
...
<MyImage src="audiolatency-diagram-soose-rtt.png" alt="..." caption="... (S)OOSE Delay with an RTT strategy." />
...
<MyImage src="audiolatency-diagram-soose-rtt-loopback-delay.png" alt="..." caption="..." />
