...
type: "work"
summary: "A quick look into Audio Latency Examiner (ALEX); a software tool for batch collecting audio latency data from both musical software and hardware devices. The app is open-source and free to download, avaliable for both Windows and Mac."
---
