...
type: "work"
summary: "the Dataset Generator for Musical Devices (DGMD) is a research project and software that can generate datasets from audio effects specifically for machine-learning tasks. This post takes a closer look at the DGMD software, including links to tutorials and download pages. Original post by Stefano Fasciani."
---

<MyImage src="dgmd-overview.png" alt="DGMD software main UI" isExpandable={true} />
