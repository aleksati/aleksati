...
date: "2024-04-05"
keywords: ["audio", "software", "machine-learning", "max", "kuramoto", "synchronization", "art", "programming", "realtime", "mapping", "sp-tools"]
type: "work"
...
<MyImage src="dsp-title.png" alt="A Digital Poème Symphonique visual overview" />
...
2. <MyLink href="#synchronization-with-the-kuramoto-model">Synchronization With The Kuramoto Model</MyLink>
3. <MyLink href="#bringing-the-kuramoto-model-to-max">Bringing The Kuramoto Model To Max</MyLink>
4. <MyLink href="#clustering-together-a-sound-engine">Clustering Together A Sound Engine</MyLink>
5. <MyLink href="#un-poème-symphonique-numérique">Un Poème Symphonique Numérique (full Performance)</MyLink>
6. <MyLink href="#references-and-further-reading">References and Further Reading</MyLink>
