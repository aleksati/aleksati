...
date: "2022-12-17"
keywords: ["band", "improvisation", "visuals", "art", "electronic", "ableton", "performance", "synth", "max"]
type: "music"
...
<MySlideshow priority={true} width={750} imgs={["kkt1.jpg", "kkt2.jpg"]} captions={["Design by Henrik Nordahl", "Design by Henrik Nordahl"]} padding={false}/>
