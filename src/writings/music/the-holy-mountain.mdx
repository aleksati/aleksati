...
<MySlideshow priority={true} width={750} imgs={["theholymountain.jpg", "theholymountain1.jpg"]} captions={["Photo by Katinka Hustad", "Photo by Katinka Hustad"]} padding={false}/>
