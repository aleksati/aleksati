...
Browsing the web in the 21st century is a bitter-sweet. Our (browsing) behavior and personal data is constantly being ... mining our and behavior and data. In the music industry, big data is used to create personalized playlists and "smart" music recommendation systems. Nobody is better at ...smart... than Spotify, currently the largest music streaming service in the known universe. For a long time, Spotify's recommendation systems have fascinated me due to their sheer performance and ability to reveal musical taste (quantitatively) like never before.

Say what you will about Spotify, but their...
